...
recyclerView=v.findViewById(R.id.poolRecylerview);
        PoolAdapter productAdapter = new PoolAdapter(getActivity(), PoolItems.getData(), new PoolAdapter.ItemClickListener() {
            @Override
            public void onItemClick(PoolItems product) {
